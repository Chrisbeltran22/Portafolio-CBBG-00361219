...
void mostrarCarta(Carta unaCarta){
    ...
    switch (unaCarta.palo){
        case Corazones: cout << " rojo de corazones"; break;
        case Diamantes: cout << " rojo de diamantes"; break;
        case Treboles: cout << " negro de treboles"; break;
        case Picas: cout << " negro de picas"; break;
    }
    cout << endl;
}
