...
int main(){
    ...
    do{
        ...
        cout << "\t9) Acceder\t10) Ver libros en espanol\n";
        cout << "\t11) Ver libros de misterio\t12) Eliminar libros de ficcion\n";
        cout << "\t13) Salir\n";
        cout << "\tOpcion elegida: ";
        cin >> opcion;
        switch(opcion){
            ...
            case 10: espanol(); break;
            case 11: Misterio(); break;
            case 12: ficcion(); break;
